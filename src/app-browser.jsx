...
const { LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, BarChart, Bar, Cell, Legend, AreaChart, Area } = Recharts;
const programData = window.PROGRAM_DATA;

const GlyphIcon = ({ size = 16, color = "currentColor", style = {} }) => (
  <span
    aria-hidden="true"
    style={{
      display: "inline-flex",
      ...
      height: size,
      color,
      fontSize: Math.max(10, size * 0.75),
      lineHeight: 1,
      flexShrink: 0,
      ...style,
    }}
...
const Award = GlyphIcon;
const BookOpen = GlyphIcon;
const FileCheck = GlyphIcon;
const Upload = GlyphIcon;
const User = GlyphIcon;
const ChevronDown = GlyphIcon;
const ChevronRight = GlyphIcon;
const TrendingUp = GlyphIcon;
const Star = GlyphIcon;
const Shield = GlyphIcon;
const Zap = GlyphIcon;
const Eye = GlyphIcon;
const Target = GlyphIcon;
const Layers = GlyphIcon;
const Activity = GlyphIcon;
const AlertCircle = GlyphIcon;
const CheckCircle2 = GlyphIcon;
const Clock = GlyphIcon;
const ArrowUpRight = GlyphIcon;
const BarChart3 = GlyphIcon;
const Info = GlyphIcon;
const ExternalLink = GlyphIcon;
const Lightbulb = GlyphIcon;
const Compass = GlyphIcon;
const GraduationCap = GlyphIcon;
const Briefcase = GlyphIcon;
const Trophy = GlyphIcon;
const PenTool = GlyphIcon;
const Search = GlyphIcon;
const MessageSquare = GlyphIcon;
const Users = GlyphIcon;
const Brain = GlyphIcon;
const Rocket = GlyphIcon;
const Sparkles = GlyphIcon;
const ChevronUp = GlyphIcon;
const X = GlyphIcon;
...
const STATIC_SOURCE_FILES = [
  {
    ...
    href: "./public/assets/course-skills.xlsx",
  ...
  {
    label: "Reference PDF",
    href: "./public/assets/document-reference.pdf",
...
if (ReactDOM.createRoot) {
  ReactDOM.createRoot(rootElement).render(<SkillEQDashboard />);
} else {
  ReactDOM.render(<SkillEQDashboard />, rootElement);
}
